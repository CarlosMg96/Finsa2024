...
$descargar = "";
if(empty($ocultar)){
  $descargar = "<a href='pdf/IAS_Finsa_2023_ENG_programado.pdf'><img src='im/download-full-report-blue.svg' style='cursor:pointer; width:250px; position:fixed;right:1em; bottom:1em; filter: drop-shadow(0 0px 3px rgba(0,0,0,0.3));''></a>";
}
...
<div id="descargas" style="display:inline-block; width:100%; font-size:0.7em; padding:0.6em 0.8em 0.3em 0.8em;background-color: #172b54;color:white;">
  <a href="$prev1">
    <img src="im/arr-left-wh.svg" style="height:20px; vertical-align: middle;"> PREVIOUS
  </a>
  
  <a href="$next1" style="float:right;">
    NEXT <img src="im/arr-right-wh.svg" style="height:20px;  vertical-align: middle; ">
  </a>
</div>
...
<div style="positon:relative;width:100vw;  border-top:1px solid #fff; border-bottom:1px solid #fff; background-color:#fff;"  >
        ...
        <div style="width:80%; margin:80px auto 0px auto;" >
          <h1 data-aos="fade-right">DOWNLOADS</h1>
        </div>

          <div style="" class="flex1 df1">
            <div class="w50 flex5">
              <img src="im/downloads-photo.jpg" style="width:85%; margin:auto; position:relative;
              box-shadow: 8px 8px 10px -2px rgba(0,0,0,0.35);" data-aos="fade-down">
            </div>
            <div class="w50 flex1">
              <div class="w50 descargas" >
                <a href='pdf/IAS_Finsa_2023_ENG_programado.pdf'>
                <img src="im/download-full-report.svg" class="descarga-el-informe" data-aos="flip-down">
                </a>
                <p>
                  <b>DOWNLOAD CHAPTERS</b>
                  <br>
                </p>
                ...
                <a target="_new" href="pdf/IAS_Finsa_2023_ENG_AboutThisReport.pdf">
                <p>
                  <span style="color:#00adef; font-weight:700">/ </span>
                  About this report
                  <img src="im/arr-dwn.svg" style="width:1.2vw">
                ...
                <a target="_new" href="pdf/IAS_Finsa_2023_ENG_GRI_SASB_TCFDIndex.pdf">
                <p>
                  <span style="color:#00adef; font-weight:700">/ </span>
                  SASB TCFD Index
                  <img src="im/arr-dwn.svg" style="width:1.2vw">
