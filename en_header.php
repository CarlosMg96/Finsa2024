...
<head>
  ...
  <title>Finsa Sustainability Report 2023</title>
...
<style type="text/css">
  .toplinks{
    color:white; text-align:center;margin:22px; font-size:0.6em; 
  ...
  @media(max-width:900px){
    ...
    <div id="topM" class="flex4" style="position:fixed; width:100vw; height:60px; background-color: #172b54;border-bottom:0.5px solid white;  z-index:20;">

      <a href="./en">
      <img src="im/finsa-logo.svg" style="position:absolute; width:160px; left:20px; top:10px; ">  
      </a>

      <a href="our-company">
      <div class="toplinks">
        OUR COMPANY
        <br><div class="dash" style="background-color: #0081c9;" data-aos="fade-down" data-aos-duration="400"></div>
      </div>
      </a>
      <a href="environmental-impact">
      <div class="toplinks">ENVIRONMENTAL IMPACT
        <br><div class="dash" style="background-color: #09c9b6;" data-aos="fade-down" data-aos-duration="800"></div>
      </div>
      </a>
      <a href="social-impact">
      <div class="toplinks">SOCIAL IMPACT
        <br><div class="dash" style="background-color: #00adef;" data-aos="fade-down" data-aos-duration="1600"></div>
      </div>
      </a>
      <a href="governance">
      <div class="toplinks">GOVERNANCE
        <br><div class="dash" style="background-color: #ff8f43;" data-aos="fade-down" data-aos-duration="1200"></div>
      </div>
      </a>
...
echo<<<HTML
      ...
      <div style="position:absolute; right:0px;top:0px; width:100px;" class="flex1">
        <a href="./$gowhere"><div style="height:100%; color:white; margin-top:18px">ES</div></a>
        <div style=" height:100%">
          <a onmouseup="reveal('bigmenu');"><img src="im/icon-burger.svg" style="height:18px; margin:18px 20px; cursor:pointer;"></a>
        </div>
      </div>
