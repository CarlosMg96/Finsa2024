      ...
      <div style="width:100%;" class="flex1">
        <div class="w17">
          ...
          <div style="color:#00adef;cursor:pointer; font-size:0.8em; margin-top:5vh;">
            LETTER FROM<br>THE PRESIDENT <img src="im/arr-right-blue.svg" style="width:1em;margin-left:0.3em">
          </div>
          </a>
          <a href="./en#descargas" onmouseup="$('#bigmenu').fadeOut();">
            <div style="color:#00adef;cursor:pointer; font-size:0.8em; margin-top:10px;">
              DOWNLOADS<img src="im/arr-right-blue.svg" style="width:1em;margin-left:0.3em">
            </div>
          </a>
        </div>
        <div style="width:80%; margin-left:10%" class="flex1">
          ...
          <div class="fourth" >
            <div class="cuartos" style="width:100%; margin-top:5vh;background-color:#DDEBF2; border-radius:0.3em; ">
              <a href="our-company">
              <img src="im/en_menuitem-1.png" 
              onmouseover="$(this).attr('src','im/en_menuitem-1-b.png');"
              onmouseout="$(this).attr('src','im/en_menuitem-1.png');"
            ...
            <a href="our-company">
              <div style="color:#00adef;cursor:pointer; font-size:0.8em; margin-top:10px;">
              READ MORE<img src="im/arr-right-blue.svg" style="width:1em;margin-left:0.3em">
              </div>
            </a>
          </div>
          ...
          <div class="fourth" >
            <div class="cuartos" style="width:100%; margin-top:5vh;background-color:#E0F2F0; border-radius:0.3em;">
              <a href="environmental-impact">
                <img src="im/en_menuitem-2.png" 
                onmouseover="$(this).attr('src','im/en_menuitem-2-b.png');"
                onmouseout="$(this).attr('src','im/en_menuitem-2.png');"
                style="width:86%;margin-left:7%;margin-top:-5vh">
              </a>
              <ul class="mi">
          ...
          <div class="fourth" >
            <div class="cuartos" style="width:100%; margin-top:5vh;background-color:#DEEFF6; border-radius:0.3em;">
              <a href="social-impact">
                <img src="im/en_menuitem-3.png" 
                onmouseover="$(this).attr('src','im/en_menuitem-3-b.png');"
                onmouseout="$(this).attr('src','im/en_menuitem-3.png');"
                style="width:86%;margin-left:7%;margin-top:-5vh">
              </a>
              <ul class="mi">
                <li>Capital Humano
          ...
          <div class="fourth" >
            <div class="cuartos" style="width:100%; margin-top:5vh;background-color:#F8ECE5; border-radius:0.3em;">
              <a href="governance">
              <img src="im/en_menuitem-4.png" 
              onmouseover="$(this).attr('src','im/en_menuitem-4-b.png');"
              onmouseout="$(this).attr('src','im/en_menuitem-4.png');"
              style="width:86%;margin-left:7%;margin-top:-5vh">
              </a>
              <ul class="mi">
